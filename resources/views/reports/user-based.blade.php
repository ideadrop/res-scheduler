        ...
        <div class="row report-filter-container">
            <div class="pull-left">
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <input id="report-user-search" name="report_user_search" placeholder="Search name, email" type="text" class="form-control" value="{{$fillSearch}}"/>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-12">
                        <select name="skills[]" id="filter-skills" data-placeholder="Filter user with skill" multiple>
            ...
            <div class="pull-right">
                <div class="col-md-12">
                    <div class="btn-group report-view-switcher">
                        <a data-href="{{route('reports.user.based')}}" class="btn btn-default active"><span class="fa fa-list-alt"></span> Detailed view</a>
                        <a data-href="{{route('reports.user.based.calender')}}" class="btn btn-default"><span class="fa fa-calendar"></span> Calender view</a>
                    </div>
                </div>
            </div>
...
function fetchReport(options) {
    ...
    var filterForm = $('#user-based-report-form');
