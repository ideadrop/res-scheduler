...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <div class="row report-filter-container">
            <div class="pull-left">
                <form id="tag-based-report-form" method="POST" action="{{route('reports.tag.based.fetch')}}" class="tag-based-report-form form-inline" autocomplete="off">
                <div class="form-group">
                    <div class="col-md-12">
                        <input id="report-tag-search" name="report_tag_search" placeholder="Search Tags" type="text" class="form-control"/>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-12">
                        ...
                        <a id="report-export" data-href="{{route('reports.tag.based.export')}}" class="btn btn-default"><span class="glyphicon glyphicon-download"></span> Export</a>
                    </div>
                </div>
...
$(document).ready(function(){
    ...
    $('body').on('click','#report-export',function(){
        var parameters = $('#tag-based-report-form').serialize();
    ...
    $('body').on('submit','#tag-based-report-form',function(e){
        e.preventDefault();
        return false;
    });
    $('#report-tag-search').keyup(function(){delayFunction(function(){
            fetchReport();
        }, 800 );
    });
});
...
function fetchReport(options) {
    ...
    var filterForm = $('#tag-based-report-form');
