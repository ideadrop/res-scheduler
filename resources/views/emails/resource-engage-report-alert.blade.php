                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:separate;mso-table-lspace:0pt;mso-table-rspace:0pt;width:100%;">
                                <tr>
                                    <td style="font-family:sans-serif;font-size:14px;vertical-align:top;">
                                        ...
                                        <h3>Free Resources(Today)</h3>
                                        <table style="width: 100%;border-collapse: collapse;text-align: left;">
                                            <tr>
                                                <th style="border: 1px solid #dddddd;padding:8px;">No.</th>
                                                <th style="border: 1px solid #dddddd;padding:8px;">Resource Name</th>
                                                <th style="border: 1px solid #dddddd;padding:8px;">Email</th>
                                                <th style="border: 1px solid #dddddd;padding:8px;">Future Allocations</th>
                                            </tr>
                                            @foreach($freeUsers as $key=>$user)
                                            <?php $profile = $user->profile; ?>
                                            <tr>
                                                <td style="border: 1px solid #dddddd;padding:8px;">{{$key+1}}</td>
                                                <td style="border: 1px solid #dddddd;padding:8px;">{{$profile->first_name.' '.$profile->last_name}}</td>
                                                <td style="border: 1px solid #dddddd;padding:8px;">{{$user->email}}</td>
                                                <td style="border: 1px solid #dddddd;padding:8px;">{{$user->present()->upcomingAllocationText()}}</td>
                                            </tr>
                                            @endforeach
                                        </table>
                                        <h3>Engaged Resources</h3>
                                        <table style="width: 100%;border-collapse: collapse;text-align: left;">
                                            <tr>
                                                <th style="border: 1px solid #dddddd;padding:8px;">No.</th>
                                                <th style="border: 1px solid #dddddd;padding:8px;">Resource Name</th>
                                            ...
                                            @foreach($engagedUsers as $key=>$user)
                                            <?php $profile = $user->profile; ?>
                                            <tr>
                                                <td style="border: 1px solid #dddddd;padding:8px;">{{$key+1}}</td>
                                                <td style="border: 1px solid #dddddd;padding:8px;">{{$profile->first_name.' '.$profile->last_name}}</td>
