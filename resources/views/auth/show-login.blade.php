...
<div class="container">
    ...
    <div class="col-md-10 col-md-offset-1 main">
        ...
        <div class="col-md-6 right-side">
            ...
            {!! Form::open(array('route' => 'auth.login','method'=>'POST','role'=>'form','class'=>'form-horizontal')) !!}
            <div class="form">
                ...
                <div class="form-group">
                    <div class="pull-left">
                        <a href="{{url('/password/reset')}}" style="line-height: 30px;color:#91B1B0;">Forgot Password?</a>
                    </div>
                    <div class="pull-right">
                        <button class="btn btn-deep-purple" type="submit"><span class="glyphicon glyphicon-log-in"></span> Login</button>
                    </div>
                </div>
            </div>
            {!! Form::close() !!}
