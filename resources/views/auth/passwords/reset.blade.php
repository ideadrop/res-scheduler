...
<div class="container">
    ...
    <div class="col-md-10 col-md-offset-1 main">
        ...
        <div class="col-md-6 right-side">
            ...
            {!! Form::open(array('url' => url("/password/reset"),'method'=>'POST','role'=>'form','class'=>'form-horizontal')) !!}
            ...
            <div class="form">
                ...
                <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                    <input id="email" type="email" class="form-control input-lg" name="email" value="{{ $email or old('email') }}" placeholder="Email">
                ...
                <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                    <input id="password" type="password" class="form-control input-lg" name="password" placeholder="Enter new password">
                ...
                <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                    <input id="password-confirm" type="password" class="form-control input-lg" name="password_confirmation" placeholder="Confirm new password">
